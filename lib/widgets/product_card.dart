...
class ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        navigationPush(context,ProductDetailsScreen(
          product: product,
        ),
      );
      },
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: Colors.black.withValues(
                              alpha:
                                  0.2), //shadow color with transparency, replace .withOpacity(0.2)
                          spreadRadius: 2, //extends the shadow further out
                          blurRadius: 2, //soften the shadow edge
                          offset: Offset(0,
                              4), //position shadow (x=0 to center horizontally, y=4 to shift downwards)
                        )
                      ],
                      borderRadius: BorderRadius.circular(20)),
                  child: Column(
